<?php
class ViewUserLinks extends View
{
    public function  __construct($data)
    {
        $linkPath = 'Link/UserLinks';
                           ...
                           <legend>My links</legend>
                              <table class="table">
                                ...
                                foreach ($data[1] as $row)
                                {
                                    ...
                                    $this->template .= ' <td><a href="/Link/ViewUserLink/?linkid='.$data[0][$i].'" class="btn btn-primary">Link info</a></td> </tr>';
                                    $i++;
                                }
        $this->template .= ' </tbody>
                              </table>';
